            ...
            <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
              <div className="mb-4">
                <div className="flex items-center border-2 py-2 px-3 rounded-md  mb-4">
                  ...
                  <input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="masukan email anda" />
                </div>
                <div className="flex items-center border-2 py-2 px-3 rounded-md  mb-4">
                ...
                <div className="flex items-center border-2 py-2 px-3 rounded-md  mb-4">
                  ...
                  <input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="buat password" />
                </div>
                <div className="flex items-center border-2 py-2 px-3 rounded-md ">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                  </svg>
                  <input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="konfirmasi password" />
                </div>
              </div>
              ...
              <div className=" text-sm font-display font-semibold text-gray-700 text-center">
                sudah punya akun ? login <a className="cursor-pointer text-red-600 hover:text-red-800">di sini</a>
              </div>
            </form>
          </div>
